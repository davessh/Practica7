 public class TarjetaInstrumentos extends Tarjeta {
        private String tipoEmparejamiento;

        public TarjetaInstrumentos(String rutaImagen, String identificador) {
        ...
        public boolean esPareja(Tarjeta otraTarjeta) {
            ...
            if (otraTarjeta instanceof TarjetaInstrumentos) {
                TarjetaInstrumentos otra = (TarjetaInstrumentos) otraTarjeta;
